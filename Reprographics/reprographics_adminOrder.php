...
if (!isActionAccessible($guid, $connection2, '/modules/Reprographics/reprographics_adminOrder.php')) {
	// Access denied
    ...
    $departmentOptions = $departmentGateway->selectDepts()->fetchAll();
    
    $form = Form::create('orderItems', $gibbon->session->get('absoluteURL') . '/modules/' . $moduleName . '/reprographics_adminOrderProcess.php', 'post');
    ...
    $row = $form->addRow();
        ...
        $row->addSelectStaff('gibbonPersonID')->selected($gibbonPersonID)->required();
